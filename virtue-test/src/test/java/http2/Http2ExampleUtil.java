...
public final class Http2ExampleUtil {
    ...
    /**
     * Response header sent in response to the http-&gt;http cleartext upgrade request.
     */
    public static final String UPGRADE_RESPONSE_HEADER = "http-to-http-upgrade";
    ...
    public static String firstValue(QueryStringDecoder query, String key) {
        ...
        List<String> values = query.params().get(key);
