...
public class ComplexRemoteCaller<T> extends AbstractCallerContainer implements RemoteCaller<T> {
    ...
    private static final Class<io.virtue.config.annotation.RemoteCaller> REMOTE_CALL_CLASS =
            io.virtue.config.annotation.RemoteCaller.class;
    ...
    private void parseRemoteCaller() {
        io.virtue.config.annotation.RemoteCaller remoteCaller = targetInterface.getAnnotation(REMOTE_CALL_CLASS);
